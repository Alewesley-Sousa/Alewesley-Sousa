...
require_once APP_PATH . 'app/models/PokemonModel.php';
...
class PokemonController
{
    ...
    public function list()
    {
        ...
        require APP_PATH . '/views/pokemon_list.php';
    }
    ...
    public function create()
    {
        ...
        require APP_PATH . "/views/pokemon_form.php";
    }
    ...
    public function edit()
    {
        ...
        require APP_PATH . "/views/pokemon_form.php"; // Correção: Adicionado ;
    }
